                    ...
                    <form action="{{ route('warga.update', $warga->id) }}" method="post" enctype="multipart/form-data">
                        ...
                        <div class="row mb-2">
                            ...
                            <div class="col-sm-10">
                                ...
                                <div class="form-check form-check-inline">
                                    <input class="form-check-input" name="jk" type="radio" id="inlineRadio2" value="P" {{ old('jk', $warga->jk) == 'P' ? 'checked' : '' }}>
                        ...
                        <div class="row mb-2">
                            ...
                            <div class="col-sm-10">
                                <input type="text" class="form-control" name="tglMeninggal" placeholder="contoh: 19-02-1999" value="{{ old('tglMeninggal', $warga->tglMeninggal) }}">
                            </div>
                        </div>
                        <div class="row mb-2">
                            <div class="col-sm-2 mt-1">
