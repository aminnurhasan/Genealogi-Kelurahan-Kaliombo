                ...
                <div class="card-body">
                    <div class="container">
                        ...
                        <div class="row mb-2">
                                ...
                                <div class="col-sm-10">
                                    <input type="text" class="form-control" name="nama" disabled value="{{ $ortu->namaAyah }} - {{ $ortu->nikAyah }}">
                                </div>
                            </div>
                            <div class="row mb-2">
                                <div class="col-sm-2 mt-1">
                                ...
                                <div class="col-sm-10">
                                    <input type="text" class="form-control" name="nama" disabled value="{{ $ortu->namaIbu }} - {{ $ortu->nikIbu }}">
                                </div>
                            </div>
                            <div class="row mb-2">
                                <div class="col-sm-2 mt-1">
