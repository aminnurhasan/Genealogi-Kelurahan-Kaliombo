    ...
    <div class="row justify-content-center">
        <div class="col">
            ...
            <div class="card">
                ...
                <div class="card-body">
                    <form action="{{ route('profil.update', $id) }}" method="post" enctype="multipart/form-data">
                        @csrf @method('POST')
                        <div class="container">
                            <div class="row mb-2">
                                ...
                                <div class="col-sm-10">
                                    <input type="text" class="form-control" name="email" disabled value="{{ old('email', $warga->email) }}">
                                </div>
                            </div>
                            <div class="row mb-2">
                                <div class="col-sm-2 mt-1">
                            ...
                            <div class="row mb-2">
                                ...
                                <div class="col-sm-10">
                                    <input type="text" class="form-control" name="tglMeminggal" placeholder="contoh: 19-02-1999" value="{{ old('tglMeninggal', $warga->tglMeninggal) }}">
                                </div>
                            </div>
                            <div class="row mb-2">
                                <div class="col-sm-2 mt-1">
                            ...
                            <div class="row mb-2">
                                ...
                                <div class="col-sm-10">
                                    <input type="number" class="form-control" name="anakKe" value="{{ old('anakKe', $warga->anakKe) }}">
                                </div>
                            </div>
                            <div class="row mb-2">
                                <div class="col-sm-2 mt-1">
